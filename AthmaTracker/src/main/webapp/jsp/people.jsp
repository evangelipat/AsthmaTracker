<%-- 
    Document   : people
    Created on : Oct 14, 2018, 9:33:36 PM
    Author     : eveli
--%>
    ...
    <body>
        ...
        <div class="container-fluid text-center">
            <div class="row content">
                <div class="col-sm-12" id="headPeople">
                    <p>Many famous people with asthma have proven themselves in the areas of sports,<br>
                        entertainment, literature and politics. <br> They didn't let asthma stop them
                        from becoming the best that they could be, and neither should you!</p>

                </div>
                <div class="col-sm-2"></div>
                <div class="col-sm-6 text-left" id="people">
                    <h3>Sports</h3>
                    <p>
                        David Beckham – professional soccer player<br>
                        Donnell Bennet – professional football player<br>
                        Jerome Bettis – professional football player<br>
                        Shannon "The Cannon" Briggs – heavyweight boxer and actor<br>
                        Bruce Davidson – Olympic equestrian<br>
                        Tom Dolan – Olympic medalist, swimming<br>
                        Chris Draft – professional football player<br>
                        Miguel Indurain – Tour de France winner (5 times) and Olympic champion<br>
                        Richard Jefferson – professional basketball player<br>
                        Jackie Joyner-Kersee – Olympic medalist, track<br>
                        Bill Koch – Olympic medalist, cross-country skiing<br>
                        Frank Lampard – professional soccer player<br>
                        Greg Louganis – Olympic medalist, diving<br>
                        Tom Malchow – Olympic medalist, swimming<br>
                        Debbie Meyer – Olympic medalist, swimming<br>
                        George Murray – wheelchair athlete and Boston Marathon winner<br>
                        Robert Muzzio – decathlete<br>
                        Paula Radcliffe – women's marathon world record holder<br>
                        Jim Ryun – Olympic medalist, track<br>
                        Alberto Salazar – marathon runner<br>
                        Paul Scholes – professional soccer player<br>
                    </p>
                    <br><br>
                    <h3>Politics</h3>
                    <p>Bill Clinton – 42nd President of the U.S.<br>
                        Calvin Coolidge – 30th President of the U.S.<br>
                        Benjamin Disraeli – British statesman, author<br>
                        Che Guevara – South American revolutionary leader<br>
                        John F. Kennedy – 35th President of the U.S.<br>
                        John Locke – 17th century politician, philosopher<br>
                        Peter the Great – Russian Czar<br>
                        Theodore Roosevelt – 26th President of the U.S.<br>
                        Daniel Webster – lawyer, statesman<br>
                        Martin Van Buren – 8th President of the U.S.</p>

                </div>
                <div class="col-sm-4 text-left" id="people">
                    <h3>Entertainment</h3>
                    <p>
                        Antonio Vivaldi – composer, conductor<br>
                        Ludwig von Beethoven – composer<br>
                        Leonard Bernstein – conductor, composer<br>
                        Bono – lead vocalist of U2<br>
                        Alice Cooper – rock singer<br>
                        Jessica Alba – actress<br>
                        Steve Allen – comedian, actor<br>
                        Jason Alexander – actor, director<br>
                        Judy Collins – folk singer<br>
                        Coolio – rapper, actor<br>
                        Jonathon Davis – singer<br>
                        Liza Minnelli – actress, singer<br>
                        Sharon Stone – actress<br>
                        Harry Styles – singer, actor<br>
                        Elizabeth Taylor – actress<br>
                        Eminem – rapper, songwriter<br>
                        Billy Joel – singer<br>
                        Diane Keaton – actress<br>
                        Pink – singer<br>
                        Arnold Schoenburg – composer<br>
                        Martin Scorsese – film director<br>
                    </p>
                    <br><br>
                    <h3>Literature</h3>
                    <p>Ambrose Bierce – journalist and author<br>
                        Elizabeth Bishop – poet and author<br>
                        Charles Dickens – author<br>
                        Oliver Wendell Holmes – poet, physician, inventor<br>
                        Samuel Johnson – 18th century poet, critic, essayist<br>
                        Marcel Proust – French novelist<br>
                        Joseph Pulitzer – publisher, philanthropist<br>
                        Dylan Thomas – poet, playwright<br>
                        John Updike – author</p>
                </div>
                <br>
                <div class="col-sm-12 text-left">
                    ...
                    <div class="col-sm-8">
                        ...
                        <a href="https://www.theguardian.com/sport/2016/apr/29/elite-athletes-asthma-simon-yates-team-sky-swimmers" style="font-size: 15px; ">Why do so many elite athletes have asthma?</a> <br>
                        <a href="https://www.popsci.com/winter-olympics-asthma"  style="font-size: 15px; ">Athletes with asthma tend to do better at the Winter Olympics</a><br>
                        <a href="https://www.healthline.com/health-news/winter-olympians-with-asthmatic-advantage"  style="font-size: 15px;">Do Winter Olympians Have an ‘Asthmatic Advantage’?</a>
                        <br>
                        <br><br>
                    </div>
                </div>
