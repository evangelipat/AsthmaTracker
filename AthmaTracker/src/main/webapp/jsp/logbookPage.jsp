<%-- 
    Document   : logbookPage
    Created on : Oct 20, 2018, 12:19:25 PM
    Author     : eveli
--%>
...
<%@page import="com.mycompany.athmatracker.model.Medication"%>
        ...
        <div class="col-sm-12">
            <div class="col-sm-6">
                ...
                <div class="form-inline">              
                    <label>Date:</label>
                    <input type="date" class="form-control" id="attack" name="attack" min="2018-01-01">
                </div>
                <br>
                    <div class="form-inline">
                    ...
                    <br>
                        <div class="form-inline">
                            ...
                            <input type="text" class="form-control" id="triggers" name="triggers" maxlength="30">
                        </div>
                        <br>
                            </div>
