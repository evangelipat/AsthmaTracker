<%-- 
    Document   : treatment
    Created on : Oct 13, 2018, 1:42:13 PM
    Author     : eveli
--%>
...
<% User user = UserDB.getUser(request.getSession().getAttribute("email").toString());%>
        ...
        <div class="container-fluid text-center">
            <div class="row content" style="height:1550px;">
                <div class="col-sm-2 sidenav" id="left-side">
                    <p><a onclick="aboutAsthmaPages('symptoms');" style="color:white;">Symptoms</a></p>
                    <br>
                    <p><a onclick="aboutAsthmaPages('triggers');" style="color:white;">Triggers</a></p>
                    <br>
                    <p><a onclick="aboutAsthmaPages('diagnosis');" style="color:white;">Diagnosis</a></p>
                    <br>
                    <p><a onclick="aboutAsthmaPages('treatment');" style="color: white;">Treatment</a></p>
                    <br>
                ...
                <div class="col-sm-8 text-left" id="main">
                    <h2>Treatment</h2>
                    <br>
                    <p>Drugs to reduce inflammation
                        Drugs to widen the airways
                        An array of drugs can be used to prevent and treat asthma in adults or in children. Doctors may use the term "rescue treatment" to describe treatment of an acute attack and "maintenance treatment" to describe treatments aimed at preventing attacks. Most of the drugs used to prevent asthma attacks are also used to treat an asthma attack but in higher doses or in different forms. Some people need to use more than one drug to prevent and treat their symptoms.
                        <br>Therapy is based on two classes of drugs:</p>
                    <ul>
                    ...
                    <br>
                    <h3>Preventing Asthma Attacks</h3>
                    <p>Asthma is a chronic condition that cannot be cured, but individual attacks can often be prevented. Prevention efforts depend on the frequency of attacks and the stimuli that trigger the attacks.
                        Identifying and eliminating or avoiding stimuli that trigger asthma attacks may commonly prevent them.
                    </p>
                    <p>Education about how to prevent and treat asthma attacks is beneficial for all people who have asthma and often for their family members.
                        Proper use of inhalers is essential for effective treatment.<br> People should know:</p>
                    <ul>
                        <li>What can trigger an attack</li>
                        <li>What helps to prevent an attack</li>
                        <li>How to use drugs properly</li>
                        <li>When to seek medical care</li>
                    </ul>
                </div>
                <div class="col-sm-2" id="left-side">
                    <img src="ventalin.png" alt="meter" width="220" height="333"  style="margin-top:50px;">
                </div>
            </div>
        </div>
<%--    </body>
