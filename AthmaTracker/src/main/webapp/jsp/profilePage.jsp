...
<div class="container-fluid text-center">
    <div class="container">
        <div class="col-sm-12 text-left" id="personalInfo">
            <h3>Personal Informations</h3>
            <br>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="firstname">Firstname:</label>
                    <div class="col-sm-10">
                        <p> <% out.println(user.getFirstname());%> </p>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="lastname">Lastname:</label>
                    <div class="col-sm-10">
                        <p><%out.println(user.getLastname());%></p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <p><%out.println(user.getBirth_date());%></p>
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="container">
        <div class="col-sm-12 text-left" id="mediacalInfo">
            <div class="col-sm-10">
            ...
            <div class="col-sm-12">
                ...
                <div class="col-sm-5"  id="saveMessage"></div>
            </div>
            <div class="col-sm-12" id="baseMedication">
            </div>
            <%
                List<Medication> medications = new ArrayList<>();
                medications = MedicationDB.getMedications(request.getSession().getAttribute("email").toString());

                out.println("<div class=\"col-sm-12\">" + " <table class=\"table\">" + " <thead>" + "<tr>");
                out.println(" <th>Medication name</th>" + "<th>Dosage</th>" + "<th></th>");

                for (int i = 0; i < medications.size(); i++) {

                    Medication medication = medications.get(i);
                    out.println("<tr>" + "<td id=\"medicationName\">" + medication.getName() + "</td>");
                    out.println("<td id=\"medicationDosage\">" + medication.getDosage() + "</td>");
                    //        out.println("<td id=\"medicationDosage\">" + medication.getId() + "</td>");
                        out.println("<td id=\"btn\">" + "<button id= \"delete\" type=\"button\" class=\"btn btn-link\" onclick=\"deleteMedication(" + "'" + medication.getName() + "'"
                                + "," + "'" + medication.getDosage() + "'" + "," + "'" + medication.getId() + "'" + ");\">Delete</button>" + "</td>" + "</tr>");
